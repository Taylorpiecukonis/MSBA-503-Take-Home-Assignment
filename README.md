...
ACADEMIC INTEGRITY AND ACKNOWLEDGMENT

This project was completed as an individual assignment in full compliance with course academic integrity policies. No work was submitted jointly with any other student.

AI-based tools were used strictly for code debugging and documentation formatting for review purposes only. Their use did not replace original student work. This disclosure is provided in accordance with instructor guidelines.
